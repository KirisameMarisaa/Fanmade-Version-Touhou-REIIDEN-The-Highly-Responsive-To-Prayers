...
class Scene:
    def __init__(self, thewindow, arg, arg_1=None):
        ...
        self.canvas = Canvas(self.scene, width=1280, height=720, bd=0, highlightthickness=0)
        ...
        if platform.system() == 'Darwin':
            self.difficulty = tk.Button(textvariable=self.difficulty_text, command=lambda: self.getdifficulty(), highlightbackground='red', fg="#b01000", font="Times 25 bold", bd=0, width="18")
            self.canvas.create_window(850, 220, window=self.difficulty)
            self.set_shoot = tk.Button(textvariable=self.set_shoot_text, command=lambda: self.getshoot(), highlightbackground='red', fg="#b01000", font="Times 22 bold", bd=0, width="18")
            self.canvas.create_window(850, 353, window=self.set_shoot)
            self.set_shovel = tk.Button(textvariable=self.set_shovel_text, command=lambda: self.getshovel(), highlightbackground='red', fg="#b01000", font="Times 22 bold", bd=0, width="18")
            self.canvas.create_window(850, 395, window=self.set_shovel)
            self.set_bomb = tk.Button(textvariable=self.set_bomb_text, command=lambda: self.getbomb(), highlightbackground='red', fg="#b01000", font="Times 22 bold", bd=0, width="18")
            self.canvas.create_window(850, 437, window=self.set_bomb)
            self.set_left = tk.Button(textvariable=self.set_left_text, command=lambda: self.getleft(), highlightbackground='red', fg="#b01000", font="Times 22 bold", bd=0, width="18")
            self.canvas.create_window(850, 479, window=self.set_left)
            self.set_right = tk.Button(textvariable=self.set_right_text, command=lambda: self.getright(), highlightbackground='red', fg="#b01000", font="Times 22 bold", bd=0, width="18")
            self.canvas.create_window(850, 521, window=self.set_right)

            self.saveandexit = tk.Button(text="Save and exit", command=lambda: self.save_and_exit(), highlightbackground='red', fg="#b01000", font="Times 32 bold italic", bd=0, width="16")
            self.canvas.create_window(500, 590, window=self.saveandexit)
            self.reset = tk.Button(text="Reset Default", command=lambda: self.optionsreset(), highlightbackground='red', fg="#b01000", font="Times 32 bold italic",  bd=0, width="16")
            self.canvas.create_window(750, 590, window=self.reset)
        else:
            self.difficulty = tk.Button(textvariable=self.difficulty_text, command=lambda: self.getdifficulty(), highlightbackground='red', fg="#b01000", font="Times 15 bold", bd=0, width="18")
            self.canvas.create_window(850, 220, window=self.difficulty)
            self.set_shoot = tk.Button(textvariable=self.set_shoot_text, command=lambda: self.getshoot(), highlightbackground='red', fg="#b01000", font="Times 12 bold", bd=0, width="18")
            self.canvas.create_window(850, 353, window=self.set_shoot)
            self.set_shovel = tk.Button(textvariable=self.set_shovel_text, command=lambda: self.getshovel(), highlightbackground='red', fg="#b01000", font="Times 12 bold", bd=0, width="18")
            self.canvas.create_window(850, 395, window=self.set_shovel)
            self.set_bomb = tk.Button(textvariable=self.set_bomb_text, command=lambda: self.getbomb(), highlightbackground='red', fg="#b01000", font="Times 12 bold", bd=0, width="18")
            self.canvas.create_window(850, 437, window=self.set_bomb)
            self.set_left = tk.Button(textvariable=self.set_left_text, command=lambda: self.getleft(), highlightbackground='red', fg="#b01000", font="Times 12 bold", bd=0, width="18")
            self.canvas.create_window(850, 479, window=self.set_left)
            self.set_right = tk.Button(textvariable=self.set_right_text, command=lambda: self.getright(), highlightbackground='red', fg="#b01000", font="Times 12 bold", bd=0, width="18")
            self.canvas.create_window(850, 521, window=self.set_right)

            self.saveandexit = tk.Button(text="Save and exit", command=lambda: self.save_and_exit(),  highlightbackground='red', fg="#b01000", font="Times 22 bold italic", bd=0, width="16")
            self.canvas.create_window(500, 590, window=self.saveandexit)
            self.reset = tk.Button(text="Reset Default", command=lambda: self.optionsreset(), highlightbackground='red', fg="#b01000", font="Times 22 bold italic", bd=0, width="16")
            self.canvas.create_window(750, 590, window=self.reset)
        self.readin_configurations()
