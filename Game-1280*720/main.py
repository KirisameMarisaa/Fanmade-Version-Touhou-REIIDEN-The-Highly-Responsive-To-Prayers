...
class MainWindow:
    ...
    Attributes:
        ...
        self.activescene        Initialize the scene which is
                                updated & displayed inside the window
        self.stack              Initialize the scene stack
                                for rapid scene switching
    """
    ...
    def run(self):
        ...
        Args:
            /
        """
        self.coldstart(init_scene.Scene(self.window, None)
                       )   # coldstart init scene
