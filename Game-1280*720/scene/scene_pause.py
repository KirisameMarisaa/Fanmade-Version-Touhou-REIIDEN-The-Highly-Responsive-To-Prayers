...
class Scene:
    def __init__(self, thewindow, arg, arg_1=None):
        ...
        self.images_menu_active = PhotoImage(
            file="./asset/bg/game_paused_active.gif")
        self.menu_active = [self.subimage(
            0, 353+64*i, 1280, 353+64*(i+1), self.images_menu_active)
            for i in range(2)]
        self.canvas = Canvas(
        ...
        self.cursur = self.canvas.create_image(
            640, 385, image=self.menu_active[cursurloc])
        self.arg = arg
        gloarg = arg
    ...
    def menupdate(self):
        ...
        self.cursur = self.canvas.create_image(
            640, 385 + 64*cursurloc, image=self.menu_active[cursurloc])
    ...
    def savedata(self):
        ...
        with open('./asset/data/continue_data.json', 'r') as f:
            ...
            insert_dict = {"Stage": stage, "Score": score,
                           "Bonus": bonus, "Tiledata": tiledata}
