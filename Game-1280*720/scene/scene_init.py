...
class Scene:
    def __init__(self, thewindow, arg, arg_1=None):
        ...
        self.animate_lines = []
        self.menu_active = [self.subimage(
            0, 40*i, 224, 40*(i+1), self.images_menu_active) for i in range(5)]
        self.canvas = Canvas(
    ...
    def menupdate(self):
        ...
        if anim_played == 4:
            ...
            self.cursur = self.canvas.create_image(
                644, 438 + 40*cursurloc, image=self.menu_active[cursurloc])
    ...
    def animate(self):
        ...
        if anim_played == 0 and (now_time - initime) > 0.1:
            ...
            self.animate_lines.append(self.canvas.create_line(
                0, rand_y, 1280, rand_y, width=3, fill='yellow'))
            self.animate_lines.append(self.canvas.create_line(
                0, rand_y + 25, 1280, rand_y+25, width=3, fill='yellow'))
            self.animate_lines.append(self.canvas.create_line(
                0, rand_y + 85, 1280, rand_y + 85, width=2, fill='yellow'))
            self.animate_lines.append(self.canvas.create_line(
                0, rand_y + 10, 1280, rand_y + 10, width=3, fill='yellow'))
            self.animate_lines.append(self.canvas.create_line(
                0, rand_y + 60, 1280, rand_y + 60, width=2, fill='yellow'))
            self.animate_lines.append(self.canvas.create_line(
                0, rand_y + 55, 1280, rand_y + 55, width=3, fill='yellow'))
            rand_y = randrange(250, 450)
            self.animate_lines.append(self.canvas.create_line(
                0, rand_y, 1280, rand_y, width=3, fill='yellow'))
            self.animate_lines.append(
            ...
            self.animate_lines.append(
                self.canvas.create_line(
                    0, rand_y + 45, 1280, rand_y + 45, width=2, fill='yellow'))
            self.animate_lines.append(
                self.canvas.create_line(
                    0, rand_y + 10, 1280, rand_y + 10, width=3, fill='yellow'))
            self.animate_lines.append(
                self.canvas.create_line(
                    0, rand_y + 30, 1280, rand_y + 30, width=2, fill='yellow'))
            self.animate_lines.append(
                self.canvas.create_line(
                    0, rand_y + 55, 1280, rand_y + 55, width=3, fill='yellow'))
